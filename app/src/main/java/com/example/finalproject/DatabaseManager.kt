...
// Manages the databases with SQL
open class DatabaseManager(context: Context) : SQLiteOpenHelper(context, "MyDb",
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        // Aidan: Created Table for all past login dates
    ...
    // Checks if data in the database exists for profile saving
    ...
    class userDataDM(context: Context): DatabaseManager(context) {
        ...
        // Sample code on inserting data to database - Testing/Implementation purposes
